    ...
    return (
        <div className="weather">
            <div id="weather-app" className="weather-app">
                <i id="weather-icon" className="wi wi-fw weather-icon wi-day-sunny"></i>
                <div className="date-time">
                    <div id="time" className="time1">1:30<span>PM</span></div>
                    <div id="date" className="date1">
                        <div id="day" className="day">Sun</div>
                        <div id="monDate" className="monDate">Sep 13</div>
                    </div>
                </div>
                ...
                <div className="location-weather">
                    ...
                    <div className="weather-temp">
                        <div id="temperature" className="temperature">84</div>
                        <div className="high-low">
                            <div id="high" className="high">92</div>
                            <div id="low" className="low">79</div>
                        </div>
                    </div>
                </div>
            </div>
